...
local cfglocation = "FNHook-Configs/" 
makefolder("FNHook-Configs") 
...
function library:New(name)
	...
	cursor.ZIndex = 1000
	cursor.ImageColor3 = COL3RGB(255, 186, 0)
	...
	Menu.Size = UDIM2(0, 600, 0, 600)
	Menu.Image = "http://www.roblox.com/asset/?id=7881406037"
	...
	do
		...
		TextLabel.BackgroundColor3 = COL3RGB(39, 39, 39)
	...
	function menu:Tab(text)
		...
		function Tab:MSector(text, side)
			...
			Section.BackgroundColor3 = COL3RGB(35, 35, 35)
			...
			Inner.BackgroundColor3 = COL3RGB(39, 39, 39)
			...
			function MSector:Tab(text)
				...
				tab1.Name = text
				tab1.Parent = Inner
				tab1.BackgroundColor3 = COL3RGB(39, 39, 39)
				tab1.BorderColor3 = COL3RGB(0, 0, 0)
				...
				function tab:Element(type, text, data, callback)
					...
					if type == "Jumbobox" then
						...
						Button.BackgroundColor3 = COL3RGB(47, 47, 47)
						Button.BorderColor3 = COL3RGB(35, 35, 35)
						...
						Drop.Parent = Button
						Drop.Active = true
						Drop.BackgroundColor3 = COL3RGB(47, 47, 47)
						Drop.BorderColor3 = COL3RGB(35, 35, 35)
						...
						Drop.ZIndex = 5
						Drop.ScrollBarImageColor3 = COL3RGB(84, 84, 84)
							...
							do
								...
								Button.MouseButton1Down:Connect(function()
									if TBLFIND(Element.value.Jumbobox, v) then
										...
										library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(175, 175, 175)})
									end
									updatetext()
					...
					elseif type == "ToggleKeybind" then
						...
						Color.Name = "Color"
						Color.Parent = Button
						Color.BackgroundColor3 = COL3RGB(47, 47, 47)
						Color.BorderColor3 = COL3RGB(35, 35, 35)
						...
						local function update()
							if Element.value.Toggle then
								...
								keybindremove(text)
								tween = library:Tween(Color, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = COL3RGB(47, 47, 47)})
								library:Tween(TextLabel, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = COL3RGB(200, 200, 200)})
							end
							values[tabname][sectorname][tabtext][text] = Element.value
							callback(Element.value)
						...
						do
							...
							Keybind.Name = "Keystrokes"
							Keybind.Parent = Button
							Keybind.BackgroundColor3 = COL3RGB(255, 186, 0 )
							...
							Frame.BackgroundColor3 = COL3RGB(47, 47, 47)
							Frame.BorderColor3 = COL3RGB(35, 35, 35)
							...
							Hold.Name = "Hold"
							Hold.Parent = Frame
							Hold.BackgroundColor3 = COL3RGB(47, 47, 47)
							Hold.BackgroundTransparency = 1.000
							Hold.BorderColor3 = COL3RGB(35, 35, 35)
							...
							Toggle.Name = "Toggle"
							Toggle.Parent = Frame
							Toggle.BackgroundColor3 = COL3RGB(47, 47, 47)
							Toggle.BackgroundTransparency = 1.000
							Toggle.BorderColor3 = COL3RGB(35, 35, 35)
					...
					elseif type == "ToggleColor" then
						...
						ColorP.BorderColor3 = COL3RGB(35, 35, 35)
						...
						Colorpick.BorderColor3 = COL3RGB(35, 35, 35)
						...
						ColorDrag.BorderColor3 = COL3RGB(35, 35, 35)
						...
						Huepick.BorderColor3 = COL3RGB(35, 35, 35)
						...
						Huedrag.BorderColor3 = COL3RGB(35, 35, 35)
					...
					elseif type == "ToggleTrans" then
						...
						Transpick.BorderColor3 = COL3RGB(35, 35, 35)
						...
						Transdrag.BorderColor3 = COL3RGB(35, 35, 35)
					...
					elseif type == "Slider" then
						...
						UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0, COL3RGB(255,140,0)), ColorSequenceKeypoint.new(1, COL3RGB(255,165,0))}
					...
					elseif type == "Button" then
						...
						Button_2.BackgroundColor3 = COL3RGB(47, 47, 47)
						Button_2.BorderColor3 = COL3RGB(35, 35, 35)
						...
						Button_2.MouseButton1Down:Connect(function()
							TextLabel.TextColor3 = COL3RGB(175, 175, 175)
		...
		function Tab:Sector(text, side)
			...
			Section.Parent = TabGui[side]
			Section.BackgroundColor3 = COL3RGB(35, 35, 35)
			Section.BorderColor3 = COL3RGB(35, 35, 35)
			Section.BorderSizePixel = 0
			...
			Inner.Parent = Section
			Inner.BackgroundColor3 = COL3RGB(39, 39, 39)
			Inner.BorderColor3 = COL3RGB(35, 35, 35)
			Inner.BorderSizePixel = 0
			Inner.Position = UDIM2(0, 1, 0, 1)
			...
			function Sector:Element(type, text, data, callback)
				...
				elseif type == "ToggleKeybind" then
					...
					do
						...
						Keybind.Parent = Button
						Keybind.BackgroundColor3 = COL3RGB(47, 47, 47)
						Keybind.BorderColor3 = COL3RGB(35, 35, 35)
						Keybind.Position = UDIM2(0, 270, 0.5, -6)
						Keybind.Text = "NONE"
						Keybind.Size = UDIM2(0, 43, 0, 12)
						Keybind.Size = UDIM2(0,txt:GetTextSize("NONE", 14, Enum.Font.SourceSansSemibold, Vec2(700, 12)).X + 5,0, 12)
				...
				elseif type == "TextBox" then
					...
					TextBox.Parent = Box
					TextBox.BackgroundColor3 = COL3RGB(47, 47, 47)
					TextBox.BorderColor3 = COL3RGB(35, 35, 35)
...
makefolder("FNHook-Luas")

local allluas = {}

for _,lua in pairs(listfiles("FNHook-Luas")) do
	local luaname = GSUB(lua, "FNHook-Luas\\", "")
...
coroutine.wrap(function()
	while wait(1/16) do
		...
		if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("UpperTorso") and values.rage.fakelag.enabled.Toggle  and values.rage.fakelag.enabled.Active then
			if LagTick == (values.rage.fakelag.amount.Dropdown == "static" and values.rage.fakelag.limit.Slider or RANDOM(1, values.rage.fakelag.limit.Slider)) then
				...
				if values.rage.fakelag.enabled.Toggle and values.rage.fakelag.enabled.Active then
...
exploits:Element("ToggleKeybind", "quick peak (doggo: hi ion <3)")
exploits:Element("Dropdown", "peak method", {options = {"freeze", "teleport", "tween"}})
...
self:Element('Jumbobox', 'hide arms', {options = {'first person', 'third person'}})
...
movement:Element("Slider", "speed", {min = 15, max = 150, default = 40})
...
chat:Element("Toggle", "chat spam", nil, function(tbl)
	if tbl.Toggle then
		while values.misc.chat["chat spam"].Toggle do
			game:GetService("ReplicatedStorage").Events.PlayerChatted:FireServer(values.misc.chat.type.Dropdown == "FortniteHook" and "We Hate Black People, We Beat Them, And Then We Molest Them" or "Get Good Get FortniteHook", false, "Innocent", false, true)
			wait(values.misc.chat["speed (ms)"].Slider/1000)
		end
	end
end)
chat:Element("Dropdown", "type", {options = {"FortniteHook", "Racist"}})
...
RunService.RenderStepped:Connect(function(step)
	...
	if PlayerIsAlive then
        ...
        if values.rage.exploits["quick peak (doggo: hi ion <3)"].Toggle then
			if values.rage.exploits["quick peak (doggo: hi ion <3)"].Active then 
				if not workspace:FindFirstChild("FreezeCharacter") then 
					local part = INST('Part',workspace)
					if values.rage.exploits['peak method'].Dropdown == 'freeze' then
	...
	for _,Player in pairs(Players:GetPlayers()) do
		...
		if Player.Character and Player.Character:FindFirstChild("HumanoidRootPart") and Player.Team ~= "TTT" and (Player.Team ~= LocalPlayer.Team or values.visuals.players.teammates.Toggle) and Player.Character:FindFirstChild("Gun") and Player.Character:FindFirstChild("Humanoid") and Player ~= LocalPlayer then
			...
			if values.visuals.players.health.Toggle then
				...
				tbl.Health.To = Vec2(tbl.Health.From.X, tbl.Health.From.Y - (Player.Character.Humanoid.Health / Player.Character.Humanoid.MaxHealth) * tbl.Box.Size.Y)
...
mt.__namecall = function(self, ...)
	...
	if method == "SetPrimaryPartCFrame" and self.Name == "Arms" then
        if values.visuals.self["third person"].Toggle and values.visuals.self["third person"].Active and LocalPlayer.Character then
            if table.find(values.visuals.self['hide arms'].Jumbobox, 'third person') then 
            ...
            if table.find(values.visuals.self['hide arms'].Jumbobox, 'first person') then 
                args[1] = args[1] * CF(99, 99, 99)
            else
                if values.visuals.self["viewmodel changer"].Toggle then
                    args[1] = args[1] * ViewmodelOffset
	...
	if method == "FireServer" and self.Name == "HitPart" then
		...
		spawn(function()
			if values.rage.exploits['peak method'].Dropdown == 'teleport' then 
				if workspace:FindFirstChild('FreezeCharacter') then
					LocalPlayer.Character.PrimaryPart.CFrame = workspace.FreezeCharacter.no.CFrame+Vector3.new(0, 3, 0)
				end
			end
			if values.rage.exploits['peak method'].Dropdown == 'tween' then 
				if workspace:FindFirstChild('FreezeCharacter') then
